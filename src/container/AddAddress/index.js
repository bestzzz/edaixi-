            ...
            <div>
                ...
                <div className="panel">
                    <form method='POST' onSubmit={this.handleSubmit}>
                        ...
                        <input type="text" name='city' id='city' placeholder='请输入区域' ref={input => this.city = input}/>
                        ...
                        <br/>
                        <input type="text" name='name' id='name' placeholder='请输入姓名' ref={input => this.name = input}/>
                        男士<input type="radio" id='sex' name='sex' value='male' ref={input => this.male = input} defaultChecked={true}/>
                        女士<input type="radio" id='sex' name='sex' value='female'/>
                        <input type="text" name='tel' id='tel' placeholder='请输入电话' ref={input => this.tel = input}/>
