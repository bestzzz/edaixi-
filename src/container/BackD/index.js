...
class BackD extends Component {
    ...
    componentWillMount() {
        console.log(this.props.user ? this.props.user.userId : null);
        this.type = [
        ...
        return (
            <div className="all">
                ...
                <div className="back">
                    ...
                    <i>反馈内容</i>
                    <div className='tel'>
                        <input placeholder='请填写您的电话...' type="text" ref={input => this.input = input}/>
                    </div>
                    <textarea placeholder='请填写您的评价...' ref={textarea => this.textarea = textarea}></textarea>
                    <Link to={this.state.typeId ? `/comments/${this.state.typeId}` : `/back`} onClick={this.handleSubmit}>提交</Link>
